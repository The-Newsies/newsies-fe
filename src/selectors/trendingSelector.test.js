import { getTrending, getLoading } from './trendingSelector';

describe('trendingSelector tests', () => {
  it('gets articles from state', () => {
    const state = {
      articles: [
        {
          source: {
    ...
    const trendingArticles = getTrending(state);

    expect(trendingArticles).toEqual([
      {
        source: {
          id: null,
          name: 'Nypost.com'
